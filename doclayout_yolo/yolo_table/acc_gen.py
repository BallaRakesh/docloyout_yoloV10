...
IMAGES_DIR = "/media/ntlpt19/5250315B5031474F/finance_data_modeling/Classification/benchmark_images/table_results/set_data/set13_seperate_pdfs/images"
LABELS_DIR = "/media/ntlpt19/5250315B5031474F/finance_data_modeling/Classification/benchmark_images/table_results/set_data/set13_seperate_pdfs/labels"
OUTPUT_DIR = "/media/ntlpt19/5250315B5031474F/finance_data_modeling/Classification/benchmark_images/table_results/set_data/validation_results/set13_seperate_pdfs/image_gp+pred_box"
csv_files = os.path.dirname(OUTPUT_DIR)
PREDICTIONS_PATH= "/media/ntlpt19/5250315B5031474F/finance_data_modeling/Classification/benchmark_images/table_results/set_data/validation_results/set13_seperate_pdfs/images/images_result_json"
...
df.to_csv(os.path.join(csv_files, "image_wise_results.csv"), index=False)
print(f"CSV file saved to {os.path.join(csv_files, 'image_wise_results.csv')}")
